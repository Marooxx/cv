...
<head>
    ...
    ?>
    <!--  Fin Requête d'affichage dynamique du Prénom et Nom  -->
    ...
    <link rel="shortcut icon" href="images/internet.ico">
</head><!--/head-->
...
<body>
    ...
    <header id="home">
        ...
        <div class="main-nav" style="background-color:#131a1d;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="scroll"><a href="#blog">Centre d'intérêts </a></li>
    ...
    <!--******************************* Compétences ************************************************ -->
    <div ><h2 style="padding:8%; margin-left=449px;"> Mes Compétences</h2></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <!-- Boucle pour afficher les competences  -->
                <?php foreach ($ligne_competence as $jauge ): ?>
                    <div class="single-skill wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
                        <p class="lead"><?= $jauge['competence'] ?></p>
                        <div class="progress">
                            <div class="progress-bar progress-bar-primary six-sec-ease-in-out" role="progressbar" style="background-color:#252829;"  aria-valuetransitiongoal="<?= $jauge['niveau'] ?>"><?= $jauge['niveau'] ?>%</div>
                        </div>
                    </div>
                <?php endforeach; ?>
    ...
    <div class="container">
        ...
        <section class="timeline">
            ...
            <ul>
                <li>
                    <div>
                        <time><?= $ligne_formation['dates_f'] ?></time>
                        <?= $ligne_formation['formation'] ?>
                        <?= $ligne_formation['etablissement_f'] ?>
            ...
            <div id="contact-us" class="parallax">
                <div class="container">
                    <div class="row">
                        <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                            <h2>Contactez - moi</h2>
                            <p>Vous trouverez sur cette page un formulaire de contact </p>
                        </div>
                    </div>
                                    ...
                                    <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="text" name="nom" class="form-control" placeholder="Saisissez votre nom" required="required">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" name="prenom" class="form-control" placeholder="Saisissez votre prénom" required="required">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="email" name="email" class="form-control" placeholder=" Saisissez votre adresse email" required="required">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="objet" class="form-control" placeholder="Objet" required="required">
                                    </div>
                                    <div class="form-group">
                                        <textarea name="message" id="message" class="form-control" rows="4" placeholder="Entrez votre message" required="required"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="btn-submit"name="envoi">Envoyez</button>
                                    </div>
                                </form>
                            </div>
                            <div class="col-sm-6">
                                <div class="contact-info wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                                    ...
                                    <ul class="address">
                                        ...
                                        <li><i class="fa fa-phone"></i> <span> mobile:</span> 06.38.01.24.98 </li>
                                        <li><i class="fa fa-envelope"></i> <span> Email:</span><a href="mailto:omarhamzi40@gmail.com"> omarhamzi40@gmail.com</a></li>
                                        <li><i class="fa fa-globe"></i> <span> Website:</span> <a href="ohamzi.ma6tvacoder.org">ohamzi.ma6tvacoder.org</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
